    ...
    <div class="col-12">
      <div class="card card-default">
        <div class="card-header card-header-border-bottom d-flex justify-content-between">
          ...
          <a href="products/add.php" class="btn btn-outline-primary btn-sm text-uppercase">
              ...
              <table id="basic-data-table" class="table nowrap dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="basic-data-table_info">
                <thead>
                  <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="basic-data-table" rowspan="1" colspan="1" aria-label="" style="width: 66px;">Código</th>
                    <th class="sorting" tabindex="0" aria-controls="basic-data-table" rowspan="1" colspan="1" aria-label="" style="width: 159px;">Nome</th>
                    <th class="sorting" tabindex="0" aria-controls="basic-data-table" rowspan="1" colspan="1" aria-label="" style="width: 25px;">Preço</th>
