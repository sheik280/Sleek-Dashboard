          ...
          <div class="card-body p-5">
            ...
            <form action="dashboard.php">
              <div class="row">
                ...
                <div class="form-group col-md-12 mb-4">
                  <input type="text" class="form-control input-lg" id="username" aria-describedby="nameHelp" placeholder="Username" />
                </div>
                <div class="form-group col-md-12 mb-4">
                  <input type="email" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Email" />
                </div>
                <div class="form-group col-md-12 mb-4">
                  <input type="tel" class="form-control input-lg" id="tel" placeholder="Contact" />
                </div>
